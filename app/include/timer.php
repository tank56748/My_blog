...
<?php
if($_SESSION['FAIL_NUM'] < 4 || !isset($_SESSION['FAIL_NUM'])){
...
<head>
	...
	<!--<script>
		...
		document.addEventListener('DOMContentLoaded', () => {
			...
			const deadline1 = new Date(Date.now() + (5 * 1000 + 999));
...
<div class="timer timer-1" style="min-height: calc(100vh - 363px - 50px); padding-top:200px;">
	<p>Вы превысили лимит вводимых паролей!</p>
	<p>Попробуйте через: </p>
	<div class="timer__items">
		<div class="timer__item timer__hours">5 минут</div>
